...
- **Task Protocol**: Claude plans and reviews; `agy` executes high-throughput bulk code writing, heavy repository lookups, and test generation. Claude is not able to write ANY code.
...
- **Delegate to `agy` immediately for:**
  ...
  - Always use opus 4.6 for any writing of code, if not available gemini 3.1 else gemini 3.5 flash
